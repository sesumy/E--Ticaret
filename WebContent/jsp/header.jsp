...
<section id="menu-10" style="background: #282828;">
				<nav class="navbar navbar-dropdown bg-color transparent navbar-fixed-top" style="    position: relative;
    left: -81px;">
					<div class="container">
							...
							<div class="mbr-table-cell">
								...
								<div class="navbar-brand">
									<a href="#" class="navbar-logo">
										<img src="images/logo2.png" alt="TEKNO"></a>
										<a class="navbar-caption" href="index">TEKNOMARKET</a>
									</div>
								...
								<%}} else{ %>
												...
												<li class="nav-item nav-btn">
													...
													<a class="nav-link btn btn-warning-outline btn-warning" href="musteriKayit">
												
														<span class="etl-icon icon-profile-male mbr-iconfont mbr-iconfont-btn" style="color: rgb(247, 100, 100);"></span>
