        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-xs-center">
                    <h3 class="mbr-section-title display-2" style="position: relative;left: -47px;">KULLANICI GİRİŞİ</h3>
                        ...
                        <div class="row row-sm-offset">
                       		<div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-35-name" style="left: 7px;position: relative;">Kullanıcı Adı<span class="form-asterisk">*</span></label>
