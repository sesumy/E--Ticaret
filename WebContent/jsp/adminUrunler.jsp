...
<%if(session.getAttribute("admin")==null){
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ürün Işlemleri</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
								...
								<a href="adminurunekle" class="btn btn-small btn-success btn-block" style="background-color: #fe980f;width: 10%;float: left;margin-bottom: 5px;position: relative;left: 156pc;">Ürün Ekle</a>
                                    <thead>
