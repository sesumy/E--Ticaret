...
<section class="mbr-section mbr-parallax-background mbr-after-navbar" id="form1-35" style="background-image: url(images/jumbotron.jpg); padding-top: 160px; padding-bottom: 160px;">
    ...
    top: -60px;
    left: -35px;">
                    <h3 class="mbr-section-title display-2">KULLANICI KAYDI</h3>
                    <small class="mbr-section-subtitle">KAYIT OLARAK İNDİRİMLERDEN YARARLANABİLİRSİNİZ...</small>
                </div>
            </div>
        </div>
    </div>
...
<!-- BURADA JAVA SINIFINA GÖNDERİYOR FORMU ACTİON="BURADA JAVA SINIFININ @WEBSERVLETİSMİVAR" -->
                    <form action="musterikayit" method="post" data-form-title="KULLANICI GİRİŞİ" style= "position: relative;left: -273px; top: -77px;">
                        <div class="row row-sm-offset">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-35-name">İsim Soyisim<span class="form-asterisk">*</span></label>
                                    <input type="text" class="form-control" name="isim" required autofocus data-form-field="isim" id="form1-35-name">
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-35-email">Email<span class="form-asterisk">*</span></label>
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-35-phone">Telefon</label>
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="form1-35-message">Adres</label>
 ...
 <br>------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    left: 308px;">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-35-name">Kullanıcı Adı<span class="form-asterisk">*</span></label>
    ...
    top: 87px;">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-35-name">Parola<span class="form-asterisk">*</span></label>
