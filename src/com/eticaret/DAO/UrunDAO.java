...
public class UrunDAO {
	...
	public static ArrayList<UrunModel> tumUrunleriGetir() throws SQLException {
		...
		try {
			...
			psmt = con.prepareStatement("Select * from urun Order By id DESC LIMIT 20;");
			...
			while (rs.next()) {
				...
				urun.setUrunFiyat(rs.getInt(5));
				urun.setUrunStok(rs.getInt(6));
				urun.setUrunResim(rs.getBinaryStream(7));
				tumUrunler.add(urun);
			}
			con.close();
	...
	public static UrunModel tekUrunGetir(int urunID) throws SQLException {
		...
		try {
			...
			if (rs.next()) {
				...
				urunler.setUrunFiyat(rs.getInt(5));
				urunler.setUrunStok(rs.getInt(6));
				urunler.setUrunResim(rs.getBinaryStream(7));
				urun.add(urunler);
			}
			con.close();
		} catch (SQLException ex) {
	...
	public static ArrayList<UrunModel> modaKategoriGetir() throws SQLException {
		ArrayList<UrunModel> moda = new ArrayList<UrunModel>();
		try {
			con = ConnectionDAO.getConnection();
	...
	public static ArrayList<UrunModel> otoKategoriGetir() throws SQLException {
		ArrayList<UrunModel> oto = new ArrayList<UrunModel>();
		try {
			con = ConnectionDAO.getConnection();
			psmt = con.prepareStatement("Select * from urun where kategoriId=1;");
			rs = psmt.executeQuery();
	...
	public static ArrayList<UrunModel> sporKategoriGetir() throws SQLException {
		ArrayList<UrunModel> spor = new ArrayList<UrunModel>();
		try {
			con = ConnectionDAO.getConnection();
			psmt = con.prepareStatement("Select * from urun where kategoriId=5;");
			rs = psmt.executeQuery();
			while (rs.next()) {
				UrunModel urun = new UrunModel();
				urun.setUrunId(rs.getInt(1));
	...
	public static ArrayList<UrunModel> kozmetikKategoriGetir() throws SQLException {
		ArrayList<UrunModel> kozmetik = new ArrayList<UrunModel>();
		try {
			con = ConnectionDAO.getConnection();
			psmt = con.prepareStatement("Select * from urun where kategoriId=6;");
			rs = psmt.executeQuery();
			while (rs.next()) {
				UrunModel urun = new UrunModel();
				urun.setUrunId(rs.getInt(1));
	...
	public static ArrayList<UrunModel> kitapKategoriGetir() throws SQLException {
		...
		try {
			con = ConnectionDAO.getConnection();
			psmt = con.prepareStatement("Select * from urun where kategoriId=7;");
			rs = psmt.executeQuery();
			while (rs.next()) {
				UrunModel urun = new UrunModel();
				urun.setUrunId(rs.getInt(1));
	...
	public static ArrayList<UrunModel> cokSatilanGetir() throws SQLException {
		ArrayList<UrunModel> coksatilanlar = new ArrayList<UrunModel>();
		try {
			con = ConnectionDAO.getConnection();
			psmt = con.prepareStatement("Select * from urun where kategoriId=8;");
			rs = psmt.executeQuery();
			while (rs.next()) {
				UrunModel urun = new UrunModel();
				urun.setUrunId(rs.getInt(1));
